...
+ (void)setMultiLabelText:(UILabel*)label
         foregroundColor1:(UIColor *)foregroundColor1
                fontName1:(UIFont *)fontName1
                  string1:(NSString *)string1
         foregroundColor2:(UIColor *)foregroundColor2
                fontName2:(UIFont *)fontName2
